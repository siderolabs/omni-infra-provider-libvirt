...
#
# Generated on 2026-07-23T13:18:28Z by kres 5f4a4c6.
...
ARG SHA
ARG TAG
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=amd64 GOOS=darwin go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS} -X ${VERSION_PKG}.Name=omni-infra-provider-libvirt -X ${VERSION_PKG}.SHA=${SHA} -X ${VERSION_PKG}.Tag=${TAG}" -o /omni-infra-provider-libvirt-darwin-amd64
...
ARG SHA
ARG TAG
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=arm64 GOOS=darwin go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS} -X ${VERSION_PKG}.Name=omni-infra-provider-libvirt -X ${VERSION_PKG}.SHA=${SHA} -X ${VERSION_PKG}.Tag=${TAG}" -o /omni-infra-provider-libvirt-darwin-arm64
...
ARG SHA
ARG TAG
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=amd64 GOOS=linux go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS} -X ${VERSION_PKG}.Name=omni-infra-provider-libvirt -X ${VERSION_PKG}.SHA=${SHA} -X ${VERSION_PKG}.Tag=${TAG}" -o /omni-infra-provider-libvirt-linux-amd64
...
ARG SHA
ARG TAG
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=arm64 GOOS=linux go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS} -X ${VERSION_PKG}.Name=omni-infra-provider-libvirt -X ${VERSION_PKG}.SHA=${SHA} -X ${VERSION_PKG}.Tag=${TAG}" -o /omni-infra-provider-libvirt-linux-arm64
